#include <stdio.h>
int main(){
    int a,b,c,d,e,f,g,h,add, lowercase, uppercase;
    float multifly;
    char l,m,o,p;
    /*
...
// 2.	C Program to Print an Integer (Entered by the User)
    ...
    scanf("%i %i", &a, &b);
    printf("\nYour numbers are %i and %i\n", a, b);
    
// 3.	C Program to Add Two Integers
    add = a + b;
    printf("The summation of two integer is: %i\n", add);

// 4.	C Program to Multiply Two Floating-Point Numbers
    multifly = a * b;
    printf("The multifly of floats are: %.2f\n", multifly);
*/
...
// 10.	C Program to Check Whether a Number is Even or Odd
    ...
    // scanf("%i", &c);
    // if(c%2 == 0){
    //     printf("The number %i is an even number", c);
    // }
    // else if(c%2 != 0){
    //     printf("Number %i is an odd number", c);
    // }
    // else{
    //     printf("Wrong input");
    // }
// 11.	C Program to Check Whether a Character is a Vowel or Consonant
    ...
    (l == uppercase || lowercase)? printf("V"): printf("C");
    // if(l == lowercase || uppercase){
    //     printf("The number is %c vowel", l);
    // }
    // else{
    //     printf("Character %c is a consonant", l);
    // }
